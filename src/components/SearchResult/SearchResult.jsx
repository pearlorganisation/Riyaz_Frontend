...
const SearchResult = ({ selectedVehicleTypes, date, returnDate }) => {
  ...
  const [sortOrder, setSortOrder] = useState("price-lth"); // 'asc' or 'desc'

  const sortVehicles = (order) => {
    const sortedVehicles = [...vehiclesData[0].sedans].sort((a, b) => {
      return order === "price-lth" ? a.price - b.price : b.price - a.price;
    });
  ...
  const handleSortChange = (event) => {
    ...
    setSortOrder(order);
    console.log(order, "my new order");
    sortVehicles(order);
    console.log(vehicles, "new vehicles");
  };
  ...
  //         })
  //         .sort((a, b) => {
  //           if (sortOrder === "price-lth") return a.price - b.price;
  //           if (sortOrder === "price-htl") return b.price - a.price;
  ...
  return (
    <div className="px-20 py-10">
      <div className="flex flex-row justify-between">
        <h1 className="mt-5">5 Results </h1>
