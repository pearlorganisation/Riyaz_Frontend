    ...
    <>
      <div className="flex flex-col justify-center items-center z-10 relative">
        <div className="flex flex-col justify-center items-center lg:h-max md:h-max h-auto">
          <img src={Profile} width={200} height={180} className="" />
        ...
        <div className="flex flex-col lg:flex-row md:flex-col gap-2 justify-between w-[80%] mb-3">
          <div className="w-full lg:w-1/2 mt-3">
            <div className="bg-white p-8 rounded-lg shadow-2xl">
              <h2 className="text-xl font-semibold mb-2 w-full flex flex-row justify-between">
                Your Profile{" "}
                <span className="text-sm text-red-600">* required</span>
              </h2>
              <p className="text-sm text-gray-500 mb-6">
                This information is used to pre-fill your details and make it
                quicker for you to complete a booking.
              </p>
              ...
              <div>
                ...
                <div className="flex justify-between">
                  <button
                    onClick={handleEdit}
                    className="w-full bg-black hover:bg-blue-900 text-white h-14 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 text-2xl font-serif"
                  >
                    Edit Profile
                  </button>
                </div>
          ...
          <div className="w-full lg:w-1/2">
            <div className="bg-white p-8 rounded-lg shadow-lg mt-3">
              ...
              <p className="text-sm text-gray-500 mb-6">
                No cards have been saved yet. Either tick “Save Card” on your
                next booking or click “Add New Card +” now
              </p>
              <button className="w-full p-3 bg-white border-2 border-black rounded-md font-semibold text-lg flex flex-row justify-center items-center">
                {" "}
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg mt-3">
              ...
              <div className="flex flex-row pt-6 items-center justify-between">
                <p className="text-sm text-gray-500">
                  Delete account for manishgupta@pearlorganisation.com
                </p>
                <button className="w-max bg-white border-2 border-red-100 rounded-md font-semibold text-lg">
