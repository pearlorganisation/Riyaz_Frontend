            ...
            <div className="flex flex-col justify-center w-full text-center lg:text-left">
              ...
              <div className="flex items-center justify-center lg:justify-start gap-2 mt-1">
                <span className="text-yellow-500">
                  {vehicle?.ratings?.averageRating} ★
                </span>
                <span className="text-gray-500">
                  {vehicle?.ratings?.numberOfRatings} reviews
                </span>
              </div>
              ...
              <div>
                <form>
                  <div class="grid grid-cols-2 gap-4 mb-4 pl-2 pr-2">
                    <div>
                      <label for="given-name" class="block font-medium">
                        Given Name *
                      </label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label for="family-name" class="block font-medium">
                        Family Name *
                      </label>
                      <input
                        type="text"
                  ...
                  <div class="grid grid-cols-2 gap-4 mb-4 pl-2 pr-2">
                    <div>
                      <label for="mobile-number" class="block font-medium">
                        Mobile Number *
                      </label>
                    ...
                    <div>
                      <label for="email-address" class="block font-medium">
                        Email Address *
                      </label>
                      <input
                        type="email"
                  ...
                  <div class="grid grid-cols-2 gap-4 mb-4 pl-2 pr-2">
                    <div>
                      <label for="flight-number" class="block font-medium">
                        Flight Number *
                      </label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label for="additional-notes" class="block font-medium">
                        Additional Notes
                      </label>
                      <textarea
                        id="additional-notes"
          ...
          <div className="bg-slate-100 rounded-lg shadow-lg w-5/12 mt-3 mb-3">
            <div className="flex flex-col">
              ...
              <div class="ml-5 mr-5 rounded-md mb-3 mt-3 p-1">
                <form>
                  <div class="mb-4">
                    <label for="card-number" class="block font-medium">
                      Card Number *
                    </label>
                  ...
                  <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                      <label for="expiry-month" class="block font-medium">
                        Expiry Month *
                      </label>
                      <select
                        id="expiry-month"
                    ...
                    <div>
                      <label for="expiry-year" class="block font-medium">
                        Expiry Year *
                      </label>
                      <select
                        id="expiry-year"
                  ...
                  <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                      <label for="cvv" class="block font-medium">
                        CVV *
                      </label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label for="name-on-card" class="block font-medium">
                        Name on Card *
                      </label>
                      <input
                        type="text"
